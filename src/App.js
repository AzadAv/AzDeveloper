      ...
      <Navbar lang={language} colors={styleColor}/>
        ...
        <Suspense fallback={<div>Loading...</div>}>
          <Routes>
              ...
              <Route path="/discover" element ={<Discover colors={styleColor} lang={language} visible={true}/>} />
              ...
              <Route path="/events" element ={<Events colors={styleColor} lang={language} visible={true}/>} />
